            ...
            <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
                ...
                <form onSubmit={handleSignIn}>
                    ...
                    <div disabled={disabled} className="mt-6">
                        <button disabled={disabled} className="w-full px-6 py-3 text-sm font-medium tracking-wide  capitalize transition-colors duration-300 transform bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50 text-white">
                            {loading ? <ImSpinner9 className='animate-spin m-auto text-white' /> : 'Sign In'}
                        </button>
                    </div>
                </form>
