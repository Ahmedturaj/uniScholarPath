                ...
                <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    {
                        reviews.map(review => <div key={review._id} className="w-full max-w-sm overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                            ...
                            <div className="flex items-center px-6 py-3 bg-gray-900">
                                ...
                                <h1 className="mx-3 text-lg font-semibold text-white">{review.reviewer}</h1>
                            </div>

                            <div className="px-6 py-4">
                                <h1 className="text-xl font-semibold text-gray-800 dark:text-white">{review.universityName}</h1>
